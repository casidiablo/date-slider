...
public class DateTimeSlider extends DateSlider {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMonthScroller.setLabeler(mMonthLabeler, mTime.getTimeInMillis(), 180, 60);
        ...
        mDayScroller.setLabeler(mDayLabeler, mTime.getTimeInMillis(), 120, 60);
    ...
    // with the right label and information about its time representation
    private final Labeler mTimeLabeler = new Labeler() {
